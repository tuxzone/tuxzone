...
augroup MiniBufExpl
  ...
  autocmd CursorHold,CursorHoldI,BufWritePost    * call <SID>DEBUG('Entering UpdateBufferStateDict AutoCmd', 10) | call <SID>UpdateBufferStateDict(bufnr("%"),0) | call <SID>DEBUG('Leaving UpdateBufferStateDict AutoCmd', 10)
if exists('##QuitPre')
