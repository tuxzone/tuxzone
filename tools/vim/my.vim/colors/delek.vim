...
hi Search term=bold ctermbg=Darkmagenta ctermfg=NONE guibg=Yellow guifg=NONE
hi SpecialKey term=bold ctermfg=Brown guifg=Blue
...
hi Current term=bold ctermbg=Grey gui=bold guibg=Lightblue
...
hi Special    term=bold      cterm=NONE ctermfg=magenta      gui=NONE guifg=deeppink
